...
#hit update file
/root/mybot-master/decenterads/update/web/cron_6cpu.sh
#extract DB-IP
...
#copy config nginx
cp /root/mybot-master/decenterads/config/web/6cpu/default /etc/nginx/sites-available/default
...
#start bot
/root/mybot-master/decenterads/config/web/6cpu/start.sh