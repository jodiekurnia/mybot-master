...
#hit update file
/root/mybot-master/decenterads/update/app/cron_2cpu.sh
#extract DB-IP
...
#copy config nginx
cp /root/mybot-master/decenterads/config/app/2cpu/default /etc/nginx/sites-available/default
...
#start bot
/root/mybot-master/decenterads/config/app/2cpu/start.sh