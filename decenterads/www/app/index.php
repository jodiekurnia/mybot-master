...
$fullurl1 = 'http://'.$arrSrv[array_rand($arrSrv)].'.rootends.com/app/?impid='.$microtime.getRandNum(9).'&'.$query.'&size=300x250';
$fullurl1 = 'http://'.$arrSrv[array_rand($arrSrv)].'.rootends.com/waardexapp/?impid='.$microtime.getRandNum(9).'&'.$query.'&size=300x250';
?>
<!DOCTYPE html>
<html>
<head>
