...
wget https://rootends.com/linux-master/decenterads/app/config/install.sh -O /mybot/install.sh
...
#create folder and move file html
mkdir /android_asset/ && cp /var/www/html/rootends_interstitial.html /android_asset/rootends_interstitial.html
